...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.cjs.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.cjs.js","tslib":"../node_modules/tslib/tslib.es6.js","@firebase/util":"../node_modules/@firebase/util/dist/index.cjs.js","@firebase/logger":"../node_modules/@firebase/logger/dist/index.esm.js","@firebase/component":"../node_modules/@firebase/component/dist/index.cjs.js","process":"../node_modules/process/browser.js"}],"../node_modules/firebase/database/dist/index.esm.js":[function(require,module,exports) {
"use strict";
...
_app.default.database().ref("todos").on("value", function (snapshot) {
  var oTodos = snapshot.val();
  var aTodos = Object.keys(oTodos);
  document.getElementById("todos").innerHTML = "";

  for (var n = 0; n < aTodos.length; n++) {
    var sTodo = oTodos[aTodos[n]]["name"];
...
function addTodo(sId, sNewTodo) {
  ...
  oParagraph.innerHTML = "<button id=\"fin_".concat(sId, "\" class=\"finished\">fin</button><button id=\"del_").concat(sId, "\" class=\"delete\">X</button> &nbsp ").concat(sNewTodo);
  document.getElementById("todos").prepend(oParagraph);
}

document.getElementById("todoForm").addEventListener("submit", function (evt) {
  evt.preventDefault();
  var oNewTodo = document.getElementById("newTodo");
  var sNewTodo = oNewTodo.value;
  oNewTodo.value = "";
  addTodo(sNewTodo);
  var sId = new Date().toISOString().replace('.', '_');
  var sPath = "todos/" + sId;

  _app.default.database().ref(sPath).set({
    name: sNewTodo
  });
});
...
document.getElementById("todos").addEventListener("click", function (evt) {
  if (hasClass(evt.target, "delete")) {
    alert("delete clicked");

    _app.default.database().ref("todos/" + evt.target.id.replace("del_", "")).remove();
  } else if (hasClass(evt.target, "finished")) {
    alert("button clicked");
  }
});
},{"./firebase.js":"firebase.js","firebase/app":"../node_modules/firebase/app/dist/index.cjs.js","firebase/database":"../node_modules/firebase/database/dist/index.esm.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
